...
class AuthServiceTest {
  ...
  /**
   * Cost 10 is used here intentionally: existing hashes in a real database may predate the cost-12
   * bump (see AuthService BCRYPT_COST). Bcrypt's self-describing format means old hashes must still
   * verify correctly.
   */
