...
/**
 * Exercises the token-extraction precedence rules of {@link JwtAuthenticationFilter}, the core of
 * the cookie-auth migration. Cookie must take precedence over header so the NestJS-equivalent guard
...
class JwtAuthenticationFilterTest {
  ...
  void cookieTakesPrecedenceOverHeader() throws Exception {
    ...
    assertEquals(
        idA.toString(), principal.id(), "Cookie token A should have won over header token B");
  }
