 ...
 *
 * <p>Mirrors the NestJS guard's {@code req.user} shape: {@code { sub: string, email: string }}.
 * Stored as the principal on the Spring SecurityContext so controllers can access it via
